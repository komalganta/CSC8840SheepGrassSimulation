...
addCoupling(fon4,"out",this,"out");
    ...
    public void layoutForSimView()
    {
        ...
        if((ViewableComponent)withName("fireonce-neuron2")!=null)
             ((ViewableComponent)withName("fireonce-neuron2")).setPreferredLocation(new Point(353, 35));
        if((ViewableComponent)withName("fireonce-neuron1")!=null)
             ((ViewableComponent)withName("fireonce-neuron1")).setPreferredLocation(new Point(171, 63));
