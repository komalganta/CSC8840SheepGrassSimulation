...
public class travelTimes extends ViewableDigraph {
  ...
  /////////////////////////////////////////////////////////
  class routeGenr extends realDevs{
...
//////////////////////////////////////////////////
  ...
  /////////////////////////////////////////
  public class varDisp extends  realDevs{
  ...
  public String getTooltipText(){
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("routeGenr")).setPreferredLocation(new Point(-3, 23));
        ((ViewableComponent)withName("arrived")).setPreferredLocation(new Point(287, 178));
        ((ViewableComponent)withName("arizonaDriving")).setPreferredLocation(new Point(105, 105));
    }
}
